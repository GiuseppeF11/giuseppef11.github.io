  ...
  return (
    <div className="right-side lg:pt-14">
      ...
      <section className="about color-gray max-lg:mb-8 lg:mb-16 lg:pt-5" id="about">
        <h1 data-aos="fade-right" className="section-heading">
          Chi sono
        </h1>
        <About />
      </section>
      ...
      <section className="projects lg:mb-16 lg:pt-5" id="projects">
        ...
        <Projects />
        <div className="mt-6 mb-16 flex items-center max-md:justify-center">
          <a
            data-aos="fade-right"
            target="_blank"
            rel="noreferrer"
      ...
      <section className="contact mb-20 lg:pt-5" id="contact">
        <h1 data-aos="fade-left" className="section-heading">
          Contattami
        </h1>
        <Contact />
      </section>
